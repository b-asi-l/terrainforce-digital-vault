...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Terrain Protection Services | We Protect Your Terrain" },
      { property: "og:description", content: "Premier security company in Kerala. 4200+ trained personnel across 12 Indian states. Comprehensive security for corporates, hospitals, IT, retail." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://terrainforce.com" },
      { property: "og:locale", content: "en_IN" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Terrain Protection Services | We Protect Your Terrain" },
      { name: "twitter:description", content: "Kerala's premier security company. 4200+ trained staff, 12 states covered." },
